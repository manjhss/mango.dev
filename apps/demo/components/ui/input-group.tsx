...
function InputGroup({variant, className, ...props }: React.ComponentProps<"div"> & { variant?: "mango" | "lingo" }) {
  return (
    <div
      ...
      className={cn(
        ...
        variant === "mango" && "has-[[data-slot=input-group-control]:focus-visible]:border-mango-ring has-[[data-slot=input-group-control]:focus-visible]:ring-mango-ring/50",
        variant === "lingo" && "has-[[data-slot=input-group-control]:focus-visible]:border-lingo-ring has-[[data-slot=input-group-control]:focus-visible]:ring-lingo-ring/50",
        className
      )}
      {...props}
    />
