...
const STEPS = [
  ...
  },
  {
    ...
    description: "Get your key from lingo.dev — the free Hobby tier is enough. Add it to your .env.local file.",
  ...
  },
  {
    ...
    description: "Define LANGS once as a const. It flows to both backend and frontend — no repetition.",
  ...
  },
  {
    ...
    description: "Create the Mango instance in a server-only file. The API key never leaves the server.",
  ...
  },
  {
    ...
    description: "MangoProvider only needs langs — no API key. Completely safe for the frontend.",
  ...
  },
  {
    ...
    description: "Pass any object to mg.translate(). Mango traverses it recursively, translates every string field, and returns the same shape with multilingual maps.",
  ...
  },
  {
    ...
    description: "useMango() gives you lang, setLang, and t(). t() resolves field[currentLang] with sourceLang as fallback.",
...
function CodeBlock({ code, lang, copyLabel, copiedLabel }: {
  code: string;
  lang: string;
  copyLabel: string;
  copiedLabel: string;
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-6xl px-4 py-12 lg:px-8">
        ...
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-3xl font-bold tracking-tight">🥭 Get Started with Mango.dev</h1>
          <p className="mt-2 text-muted-foreground text-base">Add multilingual support to your app in minutes.</p>
        </div>
        ...
        <div className="flex gap-12">
            ...
            <div className="sticky top-16 space-y-1">
              {STEPS.map((step) => (
                <button
                  ...
                  className={cn(
                    "w-full text-left flex items-center gap-2.5 rounded-md px-3 py-1.5 text-sm transition-colors",
                    activeStep === step.id
                ...
                >
                  <span className={cn(
                    ...
                    activeStep === step.id ? "text-mango-primary-foreground" : "text-muted-foreground/50"
                  )}>
                    {step.number}
                  </span>
                  {step.title}
          ...
          <main className="flex-1 min-w-0">
            ...
            <div className="pt-4 pb-12">
              ...
              <p className="text-base font-medium mb-6">{"That's it. Your app is now fully multilingual."}</p>
              <div className="flex gap-3 flex-wrap">
                ...
                <a
                  href="/en/blogs"
                  className="inline-flex items-center gap-2 rounded-md bg-mango-primary hover:bg-mango-primary/90 text-mango-primary-foreground px-4 py-2 text-sm font-medium transition-colors"
                >
                  See Demo
                </a>
              </div>
